            ...
            <div class="row mt-3">
                <div class="col-lg-7">
                    <div class="contact-wrapper">
                        ...
                        <form method="POST" action="{{ route('contact.store') }}" data-aos="fade-left" data-aos-duration="1200">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <textarea class="form-control" name="message" rows="3" name="message" placeholder="Message">{{ old('message') }}</textarea>
                                    </div>
                                </div>
