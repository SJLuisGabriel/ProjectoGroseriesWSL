        ...
        <div class="item">
            <div class="card rounded-0 border-0 text-center">
                ...
                <div class="card-img-overlay d-flex align-items-center justify-content-center">
                    ...
                    <a href="/shop" class="btn btn-primary btn-lg">Vegetables</a>
                </div>
            </div>
        </div>
        <div class="item">
            <div class="card rounded-0 border-0 text-center">
                ...
                <div class="card-img-overlay d-flex align-items-center justify-content-center">
                    ...
                    <a href="/shop" class="btn btn-primary btn-lg">Fruits</a>
                </div>
            </div>
        </div>
        <div class="item">
            <div class="card rounded-0 border-0 text-center">
                ...
                <div class="card-img-overlay d-flex align-items-center justify-content-center">
                    ...
                    <a href="/shop" class="btn btn-primary btn-lg">Meats</a>
                </div>
            </div>
        </div>
        <div class="item">
            <div class="card rounded-0 border-0 text-center">
                ...
                <div class="card-img-overlay d-flex align-items-center justify-content-center">
                    ...
                    <a href="/shop" class="btn btn-primary btn-lg">Fishes</a>
                </div>
            </div>
        </div>
        <div class="item">
            <div class="card rounded-0 border-0 text-center">
                ...
                <div class="card-img-overlay d-flex align-items-center justify-content-center">
                    ...
                    <a href="/shop" class="btn btn-primary btn-lg">Frozen Foods</a>
                </div>
            </div>
        </div>
        <div class="item">
            <div class="card rounded-0 border-0 text-center">
                ...
                <div class="card-img-overlay d-flex align-items-center justify-content-center">
                    ...
                    <a href="/shop" class="btn btn-primary btn-lg">Package</a>
                </div>
            </div>
        </div>
    </div>
